...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "AgioERC1155",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.AgioERC1155__factory>;
    getContractFactory(
      name: "AgioGovernance",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.AgioGovernance__factory>;
    getContractFactory(
      name: "AgioSMARTDAO",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.AgioSMARTDAO__factory>;
    getContractFactory(
      name: "Deploy",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.AgioERC1155>;
    getContractAt(
      name: "AgioGovernance",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.AgioGovernance>;
    getContractAt(
      name: "AgioSMARTDAO",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.AgioSMARTDAO>;
    getContractAt(
      name: "Deploy",
      address: string,
      signer?: ethers.Signer
